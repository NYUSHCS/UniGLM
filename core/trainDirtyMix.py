from core.LLMs.dirtyTrainer import MixCLTrainer
import argparse
import torch
...
if __name__ == '__main__':
    ...
    train_dataset_names = ['Amazon-Children','Amazon-Computers','Amazon-Fitness','Amazon-History','Amazon-Photo','ogbn-product','pubmed', 'ogbn-arxiv']
